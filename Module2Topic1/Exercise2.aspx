...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Text="Please fill out the registration form below:"></asp:Label>
    <br /><br />
    ...
    <asp:TextBox ID="TextBox3" placeholder="Age" TextMode="Number" runat="server"></asp:TextBox>
    ...
    <asp:Label ID="Label2" runat="server" Text="Which performance are you planning to attend?"></asp:Label>
    <asp:CheckBoxList ID="CheckBoxList1" runat="server">
        <asp:ListItem Text="Radiohead" />
        <asp:ListItem Text="Deftones" />
        <asp:ListItem Text="Twice" />
    </asp:CheckBoxList><br />
